...
export function Clientes({ data, loading, error, onRetry, onSelect }: Props) {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={7}>
                    <EmptyState message="Nenhum cliente corresponde aos filtros aplicados." />
                  </td>
                </tr>
              ) : (
                filtered.map((c) => (
                  ...
                  >
                    ...
                    <td style={TD}>R$ {c.investimento.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}</td>
